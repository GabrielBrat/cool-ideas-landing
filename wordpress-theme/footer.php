    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-brand">
                ...
                <p>Agência de marketing digital em Itajaí - SC. Transformamos ideias criativas em resultados reais para sua marca.</p>
            ...
            <div class="footer-column">
                <h4>Contato</h4>
                <ul>
                    <li><?php echo esc_html( get_theme_mod( 'contact_phone', '(47) 99999-9999' ) ); ?></li>
                    <li><?php echo esc_html( get_theme_mod( 'contact_email', 'contato@coolideas.com.br' ) ); ?></li>
                    <li><?php echo esc_html( get_theme_mod( 'contact_address', 'Itajaí, Santa Catarina' ) ); ?></li>
                </ul>
            </div>
        </div>

        <div class="footer-bottom">
            <p>&copy; <?php echo date( 'Y' ); ?> Cool Ideas. Todos os direitos reservados.</p>
            <p>Feito com 💚 em Itajaí - SC</p>
        </div>
    </div>
</footer>
...
<!-- WHATSAPP BUTTON -->
<?php
$whatsapp_number = get_theme_mod( 'whatsapp_number', '5547999999999' );
$whatsapp_msg    = rawurlencode( 'Olá! Vim pelo site e gostaria de saber mais sobre os serviços da Cool Ideas.' );
?>
<a href="https://wa.me/<?php echo esc_attr( $whatsapp_number ); ?>?text=<?php echo $whatsapp_msg; ?>" class="whatsapp-btn" target="_blank" rel="noopener" aria-label="Fale pelo WhatsApp">
